...
Usually, I get end point, request body and expected response. 
As we talked several times, I do manually, also verify what are 
the tags are dynamic and static, (dynamic tags: timestamp, uniq 
	id etc, static tags: tags are coming always same). Then I will 
start automate using rest assured library, once i get response 
from our platform I convert that response into object using jackson 
library. I verify all the static and dynamic tag from there.
...
-Postman/Ready API/Swagger/Jmeter/SoupUI
-------------
API tools for auto:
-RestAssured
-------------
