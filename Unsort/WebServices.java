...
------------------------------------------------------------------------------------
SOAP message is XML document which is used to transmit your data
WSDL message is XML document which is describes how to connect and make request to your web service
------------------------------------------------------------------------------------
